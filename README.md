...
| `SERVER_TLS_CONFIG`     | Optional path to a custom TLS configuration file for Caddy.               |
| `FSI_SERVER_IMAGE_NAME` | The FSI Server container repository                                       |
| `FSI_SERVER_PORT`       | Optional direct port mapping for FSI Server (e.g., `8080:8080`), useful when running behind a cache front-end server. |
